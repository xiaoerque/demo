package com.pcwl.demo.common.controller;

import com.alibaba.fastjson.JSON;
import com.pcwl.demo.common.service.GeneratorService;
import com.pcwl.demo.common.utils.GenUtils;
...
public class GeneratorController {
    ...
    public void code(HttpServletRequest request, HttpServletResponse response,
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"xiaoerque.zip\"");
