package com.pcwl.demo.common.utils;


import com.pcwl.demo.common.config.Constant;
import com.pcwl.demo.common.domain.ColumnDO;
import com.pcwl.demo.common.domain.TableDO;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        //templates.add("templates/common/common/Mapper.java.vm");
        ...
        //templates.add("templates/common/common/menu.sql.vm");
        return templates;
    }
...
//		}
        ...
        if (template.contains("list.html.vm")) {
            ...
            //				+ "modules" + File.separator + "common" + File.separator + className.toLowerCase() + ".html";
        }
        ...
        if (template.contains("list.js.vm")) {
            ...
            //		+ "modules" + File.separator + "common" + File.separator + className.toLowerCase() + ".js";
        }
